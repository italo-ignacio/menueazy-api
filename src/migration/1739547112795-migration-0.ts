...
export class Migration01739547112795 implements MigrationInterface {
  name = 'Migration01739547112795';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "order_address" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "address_id" integer, "order_id" integer, CONSTRAINT "PK_f07603e96b068aae820d4590270" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "device" ("id" SERIAL NOT NULL, "token" text NOT NULL, "code" text NOT NULL, "last_active" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "client_id" integer, "user_id" integer, CONSTRAINT "PK_2dc10972aa4e27c01378dad2c72" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_restaurant_restaurant_role_enum" AS ENUM('EDIT', 'VIEW')`
    );
    await queryRunner.query(
      `CREATE TABLE "user_restaurant" ("id" SERIAL NOT NULL, "restaurant_role" "public"."user_restaurant_restaurant_role_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "restaurant_id" integer, "user_id" integer, CONSTRAINT "PK_3598cdaa1f61154ba8143c1f322" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('ADMIN', 'MANAGER', 'OWNER', 'EMPLOYEE', 'DELIVERY_PERSON')`
    );
    await queryRunner.query(
      `CREATE TABLE "user" ("id" SERIAL NOT NULL, "firebase_id" character varying(128) NOT NULL, "email" character varying(255) NOT NULL, "name" character varying(255), "phone" character varying(25), "avatar_url" text, "role" "public"."user_role_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "company_id" integer, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "client_report" ("id" SERIAL NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "client_id" integer, "order_id" integer, "restaurant_id" integer, "user_id" integer, CONSTRAINT "REL_077d0b8d5e17a4d63b3b982e7c" UNIQUE ("order_id"), CONSTRAINT "PK_7bb8462cb92998e0e86ff81058a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."opening_hour_day_of_week_enum" AS ENUM('MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY', 'SATURDAY', 'SUNDAY')`
    );
    await queryRunner.query(
      `CREATE TABLE "opening_hour" ("id" SERIAL NOT NULL, "day_of_week" "public"."opening_hour_day_of_week_enum" NOT NULL, "opening_time" TIME WITH TIME ZONE NOT NULL, "closing_time" TIME WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "restaurant_id" integer, CONSTRAINT "PK_6551ceb95c04da8afd85da470c9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "payment_method" ("id" SERIAL NOT NULL, "title" character varying(100) NOT NULL, "description" text, "logo_url" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "restaurant_id" integer, CONSTRAINT "PK_7744c2b2dd932c9cf42f2b9bc3a" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TYPE "public"."review_rate_enum" AS ENUM('TERRIBLE', 'BAD', 'AVERAGE', 'GOOD', 'EXCELLENT')`
    );
    await queryRunner.query(
      `CREATE TABLE "review" ("id" SERIAL NOT NULL, "description" text NOT NULL, "rate" "public"."review_rate_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "client_id" integer, "company_id" integer, "order_id" integer, "product_restaurant_id" integer, "restaurant_id" integer, CONSTRAINT "PK_2e4299a343a81574217255c00ca" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "review_client_id_order_id_idx" ON "review" ("client_id", "order_id") `
    );
    await queryRunner.query(
      `CREATE TABLE "product_restaurant" ("id" SERIAL NOT NULL, "price" numeric(10,2) NOT NULL, "out_of_stock" boolean NOT NULL DEFAULT false, "start_sell_at" TIMESTAMP WITH TIME ZONE NOT NULL, "finish_sell_at" TIMESTAMP WITH TIME ZONE, "discount" numeric(10,2), "start_discount_at" TIMESTAMP WITH TIME ZONE, "finish_discount_at" TIMESTAMP WITH TIME ZONE, "only_in_restaurant" boolean NOT NULL DEFAULT false, "value_by_km_in_delivery" numeric(10,2), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "product_id" integer, "restaurant_id" integer, CONSTRAINT "PK_71aea1d530c0b4920a8ca0e6a23" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "restaurant_category" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "category_id" integer, "restaurant_id" integer, CONSTRAINT "PK_848ac5e4e3e511560d07e36a257" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "style" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "generic" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "color_id" integer, "company_id" integer, CONSTRAINT "PK_12a3ba7fe23b5386181ac6b0ac0" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "table" ("id" SERIAL NOT NULL, "code" text NOT NULL, "name" character varying(100) NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "restaurant_id" integer, CONSTRAINT "PK_28914b55c485fc2d7a101b1b2a4" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE UNIQUE INDEX "table_code_key" ON "table" ("code") `);
    await queryRunner.query(
      `CREATE TABLE "restaurant" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "phone" character varying(25) NOT NULL, "restaurant_url" character varying(255) NOT NULL, "contact_link" text, "description" text, "logo_url" text, "has_delivery" boolean NOT NULL, "max_delivery_distance_in_km" numeric(10,2) NOT NULL DEFAULT '10', "minimum_delivery_value" numeric(10,2) NOT NULL DEFAULT '0', "minimum_order_value" numeric(10,2) NOT NULL DEFAULT '0', "open" boolean NOT NULL, "open_for_delivery" boolean, "value_by_km_in_delivery" numeric(10,2) NOT NULL DEFAULT '0', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "company_id" integer, "style_id" integer, CONSTRAINT "PK_649e250d8b8165cb406d99aa30f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "address" ("id" SERIAL NOT NULL, "street" character varying(255) NOT NULL, "city" character varying(255) NOT NULL, "state" character varying(255) NOT NULL, "zip_code" character varying(25) NOT NULL, "country" character varying(255) NOT NULL, "complement" character varying(255), "latitude" numeric(10,8) NOT NULL, "longitude" numeric(11,8) NOT NULL, "number" character varying(30) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_d92de1f82754668b5f5f5dd4fd5" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "client_address" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "address_id" integer, "client_id" integer, CONSTRAINT "PK_fea7ca529948e3e15c4f91b37fc" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order" ("id" SERIAL NOT NULL, "price" numeric(10,2) NOT NULL, "total" numeric(10,2) NOT NULL, "delivery_price" numeric(10,2), "observation" text, "status" "public"."order_status_enum" NOT NULL, "type" "public"."order_type_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "client_id" integer, "delivery_person_id" integer, "restaurant_id" integer, "table_id" integer, CONSTRAINT "PK_1031171c13130102495201e3e20" PRIMARY KEY ("id"))`
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "product_option_group" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "min_selection" integer NOT NULL DEFAULT '0', "max_selection" integer NOT NULL DEFAULT '1', "required" boolean NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "product_id" integer, CONSTRAINT "PK_d76e92fdbbb5a2e6752ffd4a2c1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "product_option_item" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "image_url" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "product_id" integer, "product_option_group_id" integer, CONSTRAINT "PK_8559d5b48467930210ce983e3f3" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "order_product_option_item" ("id" SERIAL NOT NULL, "quantity" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "order_product_id" integer, "product_option_item_id" integer, CONSTRAINT "PK_9656ecf7004f670538ed959f622" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "order_product" ("id" SERIAL NOT NULL, "observation" text, "quantity" integer NOT NULL, "price" numeric(10,2) NOT NULL, "subtotal" numeric(10,2) NOT NULL, "status" "public"."order_product_status_enum" NOT NULL DEFAULT 'PENDING', "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "order_id" integer, "product_id" integer, CONSTRAINT "PK_539ede39e518562dfdadfddb492" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "product_image" ("id" SERIAL NOT NULL, "url" text NOT NULL, "primary" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "product_id" integer, CONSTRAINT "PK_99d98a80f57857d51b5f63c8240" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "company_id" integer, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "product_category" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "category_id" integer, "product_id" integer, CONSTRAINT "PK_0dce9bc93c2d2c399982d04bef1" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "category" ("id" SERIAL NOT NULL, "name" character varying(100) NOT NULL, "description" text, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "company_id" integer, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "plan_price" ("id" SERIAL NOT NULL, "monthly_price" numeric(10,2) NOT NULL, "price_of_restaurant" numeric(10,2) NOT NULL, "price_of_product" numeric(10,2) NOT NULL, "discount" numeric(10,2), "period" "public"."plan_price_period_enum" NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "currency_id" integer, "plan_id" integer, CONSTRAINT "PK_4333279b07456b24b55fff8b740" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "plan_price_currency_plan_period_idx" ON "plan_price" ("currency_id", "plan_id", "period") `
    );
    await queryRunner.query(
      `CREATE TABLE "register_request" ("id" SERIAL NOT NULL, "email" character varying(255) NOT NULL, "name" character varying(255) NOT NULL, "phone" character varying(25) NOT NULL, "company_name" character varying(255) NOT NULL, "description" text, "code" uuid NOT NULL DEFAULT uuid_generate_v4(), "can_register" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "currency_id" integer, CONSTRAINT "PK_c567fb79b69366996980c6380fc" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "company" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "logo_url" text, "company_url" character varying(255) NOT NULL, "custom_domain" character varying(255), "dns_cname" character varying(255), "domain_verified" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "currency_id" integer, "subscription_id" integer, CONSTRAINT "REL_8b9e234380f132cb34950b0d83" UNIQUE ("subscription_id"), CONSTRAINT "PK_056f7854a7afdba7cbd6d45fc20" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "coupon" ("id" SERIAL NOT NULL, "code" character varying(20) NOT NULL, "discount" numeric(10,2) NOT NULL, "duration" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_fcbe9d72b60eed35f46dc35a682" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(`CREATE UNIQUE INDEX "coupon_code_key" ON "coupon" ("code") `);
    await queryRunner.query(
      `CREATE TABLE "subscription_coupon" ("id" SERIAL NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "coupon_id" integer, "subscription_id" integer, CONSTRAINT "PK_9d205b7b3b05e92236796d6c5b9" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "price" numeric(10,2) NOT NULL, "restaurant_limit" integer NOT NULL, "product_limit" integer NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "contact_admin" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "plan_id" integer, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_restaurant" ADD CONSTRAINT "FK_096dda0b8ca9294344b36ebc957" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "product_restaurant" ADD CONSTRAINT "FK_e1dd7bbbff69e281d712675c53d" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "product_restaurant" DROP CONSTRAINT "FK_e1dd7bbbff69e281d712675c53d"`
    );
    await queryRunner.query(
      `ALTER TABLE "product_restaurant" DROP CONSTRAINT "FK_096dda0b8ca9294344b36ebc957"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TABLE "product_restaurant"`);
