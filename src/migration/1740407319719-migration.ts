...
export class Migration1740407319719 implements MigrationInterface {
  name = 'Migration1740407319719';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "price" numeric(10,2) NOT NULL, "restaurant_limit" integer NOT NULL, "product_limit" integer NOT NULL, "code" uuid NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "contact_admin" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "plan_id" integer NOT NULL, CONSTRAINT "UQ_73c5e37cd0bb0c5a42d9ffa704f" UNIQUE ("code"), CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "restaurant" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "phone" character varying(25) NOT NULL, "restaurant_url" character varying(255) NOT NULL, "contact_link" text, "description" text, "logo_url" text, "open" boolean NOT NULL, "open_for_delivery" boolean, "has_delivery" boolean NOT NULL, "max_delivery_distance_in_km" real NOT NULL, "minimum_delivery_price" real NOT NULL, "minimum_order_price" real NOT NULL, "price_by_km_in_delivery" real NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, "company_id" integer NOT NULL, "style_id" integer NOT NULL, CONSTRAINT "PK_649e250d8b8165cb406d99aa30f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
