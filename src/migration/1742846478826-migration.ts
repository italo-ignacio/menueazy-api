...
export class Migration1742846478826 implements MigrationInterface {
  name = 'Migration1742846478826';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "description" text, "price" real NOT NULL, "out_of_stock" boolean NOT NULL DEFAULT false, "discount" real, "start_discount_at" TIMESTAMP WITH TIME ZONE, "finish_discount_at" TIMESTAMP WITH TIME ZONE, "only_in_restaurant" boolean NOT NULL DEFAULT false, "published" boolean NOT NULL DEFAULT false, "highlight" boolean NOT NULL DEFAULT false, "price_by_km_in_delivery" real, "restaurant_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
