...
export class Migration1744110976333 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "product_ingredient_product" ON "product_ingredient" ("product_id") `
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "product_ingredient_unique" ON "product_ingredient" ("product_id", "ingredient_id") `
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "subscription" ("id" SERIAL NOT NULL, "price" real NOT NULL, "restaurant_limit" integer NOT NULL, "product_limit" integer NOT NULL, "plan_id" integer NOT NULL, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "contact_admin" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_8c3e00ebd02103caa1174cd5d9d" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "restaurant" ("id" SERIAL NOT NULL, "name" character varying(255) NOT NULL, "phone" character varying(25) NOT NULL, "restaurant_url" character varying(255) NOT NULL, "contact_link" text, "description" text, "logo_url" text, "open" boolean NOT NULL DEFAULT false, "open_for_delivery" boolean, "has_delivery" boolean NOT NULL, "minimum_order_price" real NOT NULL, "max_delivery_distance_in_km" real NOT NULL DEFAULT '10', "minimum_delivery_price" real NOT NULL DEFAULT '5', "price_by_km_in_delivery" real NOT NULL DEFAULT '2', "company_id" integer NOT NULL, "style_id" integer, "address_id" integer, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "finished_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_649e250d8b8165cb406d99aa30f" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "delivery_person" ADD CONSTRAINT "FK_5e799c002c79aa381eeeb0c1a6f" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "ingredient_data" ADD CONSTRAINT "FK_e9f447737edfa10031baec061e8" FOREIGN KEY ("ingredient_id") REFERENCES "ingredient"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient_movement" ADD CONSTRAINT "FK_5943de3e8d4ddb8b8ceffa0fcf8" FOREIGN KEY ("ingredient_id") REFERENCES "ingredient"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient" ADD CONSTRAINT "FK_e13813daeddf987123b9957af9f" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "product_ingredient" ADD CONSTRAINT "FK_a7a4b2de441d2ab00df5b0d4cdd" FOREIGN KEY ("product_id") REFERENCES "product"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "product_ingredient" ADD CONSTRAINT "FK_3f9b3e7181dc8cd771e6d513b7b" FOREIGN KEY ("ingredient_id") REFERENCES "ingredient"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "review" ADD CONSTRAINT "FK_9e0a456057cd16f910bfad306ad" FOREIGN KEY ("restaurant_id") REFERENCES "restaurant"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product_option_item" ADD CONSTRAINT "FK_17c8c0bc02defc2bf832162350d" FOREIGN KEY ("product_option_group_id") REFERENCES "product_option_group"("id") ON DELETE CASCADE ON UPDATE CASCADE`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order" ADD CONSTRAINT "FK_f07603e96b068aae820d4590270" FOREIGN KEY ("address_id") REFERENCES "address"("id") ON DELETE SET NULL ON UPDATE CASCADE`
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD CONSTRAINT "FK_59c426f683eb876b8be2f033fd3" FOREIGN KEY ("review_id") REFERENCES "review"("id") ON DELETE SET NULL ON UPDATE CASCADE`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order_product_option_item" DROP CONSTRAINT "FK_17c8c0bc02defc2bf832162350d"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_ingredient" DROP CONSTRAINT "FK_3f9b3e7181dc8cd771e6d513b7b"`
    );
    await queryRunner.query(
      `ALTER TABLE "product_ingredient" DROP CONSTRAINT "FK_a7a4b2de441d2ab00df5b0d4cdd"`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient" DROP CONSTRAINT "FK_e13813daeddf987123b9957af9f"`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient_movement" DROP CONSTRAINT "FK_5943de3e8d4ddb8b8ceffa0fcf8"`
    );
    await queryRunner.query(
      `ALTER TABLE "ingredient_data" DROP CONSTRAINT "FK_e9f447737edfa10031baec061e8"`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "delivery_person" DROP CONSTRAINT "FK_5e799c002c79aa381eeeb0c1a6f"`
    );
